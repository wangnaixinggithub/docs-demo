...
![](https://blogwnx-bucket.oss-cn-beijing.aliyuncs.com/img/image-20240511093418209.png)
...
![](https://blogwnx-bucket.oss-cn-beijing.aliyuncs.com/img/image-20240511093556777.png)

#### 生成路径字典

幂集算法

:::details `power-set.js`
