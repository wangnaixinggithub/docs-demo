...
![image-20240302191559763](13_重学 Java 设计模式：实战责任链模式「模拟618电商大促期间，项目上线流程多级负责人审批场景」.assets/image-20240302191559763.png)
...
![image-20240302191615571](13_重学 Java 设计模式：实战责任链模式「模拟618电商大促期间，项目上线流程多级负责人审批场景」.assets/image-20240302191615571-17093781765625.png)
...
- 上这个业务模型中责任链结构的核心部分，通过三个实现了统一抽象类`AuthLink`的不同规则，再进行责任编排模拟出一条链路。这个链路就是业务中的责任链。
