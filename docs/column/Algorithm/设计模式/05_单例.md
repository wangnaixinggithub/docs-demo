# 单例模式「7种单例模式，Effective Java 作者推荐枚举单例模式」
...
:::details `Effective Java作者推荐的枚举单例(线程安全)`
...
- 建议在学习的过程中一定要加以实践，否则很难完完整整的掌握一整套的知识体系。例如案例中的出现的`Effective Java`一书也非常建议大家阅读。另外推荐下这位大神的Github：https://github.com/jbloch
